...
public class Query {
  ...
  private List<String> bookedToday = new ArrayList<String>();
  ...
  public String transaction_book(int itineraryId) {
    ...
    } else if (!bookedToday.isEmpty()) { // There are bookings and search isn't empty
	String pendingBook = search.get(itineraryId).getFlight(); // String about flight
	if (bookedToday.contains(pendingBook)) { // Duplicate booking
	    return "You cannot book two flights in the same day\n";
	}
    } else { // Can make a booking
	...
	try {
	    ...
	    bookedToday.add(flightInfo.getFlight());
